...
12. Да се дефинира функция `accumulate(combiner, null-value, term, a, next, b)`,
която акумулира всички цели числа в интервала `[a, b]` чрез
бинарната функция `combiner` в акумулатор с първоначална стойност `null-value`.
...
13. Да се дефинира функцията `reverse-digits(n)`, която
